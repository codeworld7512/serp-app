...
var C = {
  ...
  M = function (t) {
    ...
    "function" == typeof u && (d = u(d, f)),
      null !== (e = n.config.series[a].data[s]) &&
        void 0 !== e &&
        e.x &&
        (c = n.config.series[a].data[s].x + ":"),
      ...
      r(t, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            e = new O(this.ctx).getActiveConfigSeriesIndex("asc", [
              "line",
              "area",
              "scatter",
              "bubble",
            ...
            var e = this.w,
              ...
              s =
                a >= 2 && a % 2 == 0
                  ...
                  : Math.floor(a / 2) + 1;
            e.globals.isBarHorizontal &&
              (s = new O(this.ctx).getActiveConfigSeriesIndex("desc") + 1);
            var r = e.globals.dom.baseEl.querySelector(
